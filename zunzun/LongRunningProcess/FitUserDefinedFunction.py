...
class FitUserDefinedFunction(FittingBaseClass.FittingBaseClass):
    ...
    def SpecificEquationUnboundInterfaceCode(self, request):
        ...
        if self.dimensionality == 2:
            self.dictionaryToReturn['udfFunctionsDict'] = pyeq2.Models_2D.UserDefinedFunction.UserDefinedFunction.functionDictionary
        else:
            self.dictionaryToReturn['udfFunctionsDict'] = pyeq2.Models_3D.UserDefinedFunction.UserDefinedFunction.functionDictionary
