...
class FitUserSelectablePolyfunctional(FittingBaseClass.FittingBaseClass):
    ...
    X2DList = pyeq2.PolyFunctions.GenerateListForPolyfunctionals_2D()
    X3DList = pyeq2.PolyFunctions.GenerateListForPolyfunctionals_3D_X()
    Y3DList = pyeq2.PolyFunctions.GenerateListForPolyfunctionals_3D_Y()        
